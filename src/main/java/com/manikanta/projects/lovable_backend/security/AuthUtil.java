...
public class AuthUtil {
    ...
    private String jwtSecretKey; // inject key from the application properties , for production ready code use env var or something secure way

    // convert bytes array into secret key
